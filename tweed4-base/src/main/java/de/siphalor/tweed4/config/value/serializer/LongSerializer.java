...
public class LongSerializer extends ConfigValueSerializer<Long> {
	@Override
	public <V> Long read(DataSerializer<V> serializer, V value) throws ConfigReadException {
		return serializer.toLong(value);
	}

	@Override
	public <V> Object write(DataSerializer<V> serializer, Long value) {
		return value;
	}
