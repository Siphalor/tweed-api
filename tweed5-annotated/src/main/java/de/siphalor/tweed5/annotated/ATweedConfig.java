 ...
 * You can let Tweed do the registration by registering the annotated class or a field with that class as an entry point <code>tweed5:config</code> in the <code>fabric.mod.json</code> file.
 */
