...
import de.siphalor.tweed5.tailor.DropdownMaterial;
import de.siphalor.tweed5.tailor.coat.entry.CoatDropdownSelectInput;
import de.siphalor.tweed5.tailor.coat.entryhandler.ConvertingConfigEntryHandler;
import de.siphalor.tweed5.tailor.coat.entryhandler.SimpleConfigEntryHandler;
import de.siphalor.tweed5.tailor.screen.ScreenTailor;
import de.siphalor.tweed5.tailor.screen.ScreenTailorScreenFactory;
import de.siphalor.tweed5.util.DirectListMultimap;
...
public class CoatTailor extends ScreenTailor {
	private static final String TRANSLATION_PREFIX = "tweed5_tailor_screen.screen.";
	private static final String ENUM_TRANSLATION_PREFIX = "tweed5_tailor_screen.enum.";
